<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        $_POST['email'];
        $data_nascimento = // Dados enviados via formulário
        $_POST['data_nascimento'];
        $genero = // Dados enviados via formulário
        $_POST['genero'];
        $senha = password_hash(// Dados enviados via formulário
        $_POST['senha'], PASSWORD_DEFAULT);
        $sql = "INSERT INTO cliente (nome, telefone, endereco, email, data_nascimento, genero, senha)
