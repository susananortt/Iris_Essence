<?php
    ...
    $_POST['id_cliente']) && isset(// Dados enviados via formulário
    $_POST['acao']) && // Dados enviados via formulário
    $_POST['acao'] === 'alterar') {
        $id_cliente = // Dados enviados via formulário
        $_POST['id_cliente'];
        ...
        $_POST['genero']);
        $perfil = trim(// Dados enviados via formulário
        $_POST['perfil']);
        
        $sql = "UPDATE cliente SET nome = :nome, telefone = :telefone, endereco = :endereco, email = :email, data_nascimento = :nascimento,
        genero = :genero, perfil = :perfil";
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST" && isset(// Dados enviados via formulário
    $_POST['busca_cliente']) && (!isset(// Dados enviados via formulário
    $_POST['acao']) || // Dados enviados via formulário
    $_POST['acao'] !== 'alterar')) {
...
<select type="option" id="genero" name="genero" value="<?= htmlspecialchars($cliente['genero']) ?>" required>
